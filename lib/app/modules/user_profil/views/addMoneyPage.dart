        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Row(
                children: [
                  Text(
                    'myNumber'.tr,
                    style: TextStyle(fontFamily: gilroyMedium, fontSize: 18),
                  ),
                  Expanded(
                    child: Text(
                      number,
            ...
            Padding(
              ...
              child: Text(
                'addMoneyTitle'.tr,
                style: TextStyle(fontFamily: gilroyRegular, fontSize: 20),
              ),
            ),
            Padding(
              padding: const EdgeInsets.all(15.0),
              child: Text(
                'addMoneySubTitle'.tr,
                style: TextStyle(fontFamily: gilroySemiBold, color: Colors.red, fontSize: 18),
              ),
            ),
            Container(
              height: 300,
  ...
  Container sendMoneyButton(bool margin) {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () async {
          final String phoneNumber = '+99362990344';
        ...
        child: Text(
          ...
          style: const TextStyle(color: Colors.white, fontFamily: gilroyMedium, fontSize: 22),
        ),
      ),
    );
  }
